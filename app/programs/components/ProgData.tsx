...
export default function ProgData() {
  ...
  return (
      <div>
          ...
          <div className='grid grid-cols-1 phone:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 xl:px-24 lg:px-24 md:px-20 sm:p-5 phone:p-5'>
              {data && data.map((item, i) => {
                  return (
                      <Link href={item.href} className="card bg-white hover:bg-gray-100 shadow-md border hover:drop-shadow-xl duration-300 hover:z-40 ease-in" key={i} >
